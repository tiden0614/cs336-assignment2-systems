...
from cs336_systems.flash_attn import FlashAttention2Func, TorchAttentionFunc
import cs336_systems.distributed as distributed
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    return distributed.broadcast_model_param(module)
...
def ddp_individual_parameters_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    return distributed.all_reduce_gradiens(ddp_model, optimizer)
